...
CustomModalProps) {
  const getGradientClass = () => {
    if (module === MODULES.EVENT) return "from-[#ff6a00] to-[#d28600]";
    if (module === MODULES.DISTRICT) return "from-cyan-500 to-blue-500";
    if (module === MODULES.SESSION) return "from-green-500 to-emerald-500";
    if (module === MODULES.USER) return "from-purple-500 to-pink-500";
